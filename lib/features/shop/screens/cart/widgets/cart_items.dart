...
import 'package:sneakerhead/common/widgets/products/cart/add_remove_button.dart';
import 'package:sneakerhead/common/widgets/products/cart/cart_item.dart';
                  ...
                  if (showAddRemoveButton)
                    Row(
                      ...
                      children: [
                        ...
                        /// --Product Total price
                        TProductPriceText(
                          price: (item.price * item.quantity).toStringAsFixed(
                            1,
                          ),
                        ),
                      ],
